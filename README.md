...
get the app created:
    ...
    $ heroku apps:create peridottest
    Creating peridottest... done, stack is cedar
    http://peridottest.herokuapp.com/ | git@heroku.com:peridottest.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://peridottest.herokuapp.com deployed to Heroku

    To git@heroku.com:peridottest.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://peridottest.herokuap.com
    ["Hello" :from Heroku]
